	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			if (postAction.equals("unregistereduser")) {
				...
				// unsets user_session variable and logout user. I am not sure
				// how to unset the session var.
				...
				getServletContext().getRequestDispatcher(
						"/createadvertisement.jsp").forward(request, response);
				;
			} else if (postAction.equals("createproduct")) {
				getServletContext().getRequestDispatcher("/createproduct.jsp")
						.forward(request, response);
				;
				...
				// request.setAttribute("viewall", objProduct);
				// objProduct.viewAllProducts();
				getServletContext().getRequestDispatcher("/adminlogin.jsp")
						.forward(request, response);
				;
				...
				getServletContext().getRequestDispatcher("/createchannel.jsp")
						.forward(request, response);
				;
			} else if (postAction.equals("viewchannel")) {
				request.setAttribute("viewchannel", objChannel);
				// objChannel.viewChannelDetails();
				getServletContext().getRequestDispatcher("/viewallchannel.jsp")
						.forward(request, response);
				;
